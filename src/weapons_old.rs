...
impl AttackMethods {
    ...
    pub fn try_from_iter<T: Iterator<Item = AttackMethod>>(mut iter: T) -> Result<Self> {
...
impl<'a> Weapon<'a> {
    pub fn position(&self) -> WeaponPosition {
        self.position
    }
    ...
    pub fn damage_type(&self) -> DamageType {
        self.details.damage_type
    }

    pub fn attack_methods(&self) -> &AttackMethods {
        &self.details.attack_methods
    }
    ...
    pub fn has_tag(&self, tag: &Tag) -> bool {
        self.details.has_tag(tag)
    }

    pub fn accuracy(&self, attack_method: &AttackMethod) -> Result<i8> {
        self.details.accuracy(attack_method)
    }

    pub fn damage(&self, attack_method: &AttackMethod) -> i8 {
        self.details.damage(attack_method)
    }
}