use crate::{
    ...
    exaltation::ExaltationMartialArtistMemo, weapons::WeaponId,
};

use super::{charm::MartialArtsCharm, charm_id::MartialArtsCharmId};

/// A specific Martial Arts style as known by a character.
pub struct MartialArtistMemo<'char>(pub(crate) ExaltationMartialArtistMemo<'char>);

impl<'char> MartialArtistMemo<'char> {
    /// The style's name.
