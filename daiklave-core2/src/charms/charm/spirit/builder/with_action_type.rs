...
use crate::{book_reference::BookReference, charms::{charm::SpiritCharmKeyword, CharmCostType, CharmActionType}};

use super::SpiritCharmBuilderWithDuration;

pub struct SpiritCharmBuilderWithActionType {
...
impl SpiritCharmBuilderWithActionType {
    ...
    /// Sets the duration of the Charm
    pub fn duration(self, duration: String) -> SpiritCharmBuilderWithDuration {
        SpiritCharmBuilderWithDuration {
            name: self.name,
