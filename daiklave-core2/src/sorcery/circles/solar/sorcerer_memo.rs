...
use crate::sorcery::{SorceryArchetypeId, SorceryArchetype, ShapingRitualId, ShapingRitual, SpellId, circles::{terrestrial::TerrestrialSpell, sorcery_circle::SorceryCircle, celestial::CelestialSpell}, Spell};

use super::{sorcerer_view::SolarCircleSorcererView, SolarSpell};
...
impl<'char> SolarCircleSorcererMemo {
...
impl<'source> From<SolarCircleSorcererView<'source>> for SolarCircleSorcererMemo {
