use crate::{CharacterEventSource, CharacterMutationError, CharacterMutation, Character};
...
impl<'source, T> CharacterEvent<'source> for T where T: Into<CharacterMutation> {
    fn apply_event(self, event_source: &'source mut CharacterEventSource) -> Result<Character<'source>, CharacterMutationError> {
