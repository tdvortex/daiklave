...
use crate::{
    intimacies::{
        intimacy::{IntimacyError, IntimacyId, IntimacyLevel, IntimacyMutation},
        Intimacies,
    },
...
impl<'view, 'source> Character<'source> {
    ...
    pub fn add_intimacy(
        ...
        let IntimacyMutation { id, inner } = intimacy;
    ...
    pub fn set_intimacy_level(
        ...
        let inner = self
            .intimacies
            .get_mut(&id)
            .ok_or(CharacterMutationError::IntimacyError(
                IntimacyError::NotFound,
            ))?;
    ...
    pub fn set_intimacy_description(
        &mut self,
        id: IntimacyId,
