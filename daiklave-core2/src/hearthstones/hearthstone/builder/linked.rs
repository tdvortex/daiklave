...
/// A Linked hearthstone. It may not be WildBorn, ManseBorn, or Steady, but it
/// may be Dependent.
pub struct LinkedHearthstoneBuilder {
    ...
    pub fn build(self) -> AddHearthstone {
        (
            ...
            HearthstoneTemplate {
                ...
                stability: HearthstoneStability::Linked,
            },
        )
    }
}
