...
/// A builder for a base artifact weapon, after the damage type has been specified.
pub struct BaseArtifactWeaponBuilderWithDamageType(pub(crate) BaseWeaponBuilderWithDamageType);

impl BaseArtifactWeaponBuilderWithDamageType {
    ...
    pub fn brawl(self) -> BaseArtifactWeaponBuilderWithAttack {
        BaseArtifactWeaponBuilderWithAttack(self.0.brawl())
    }
    ...
    pub fn melee(self) -> BaseArtifactWeaponBuilderWithAttack {
        BaseArtifactWeaponBuilderWithAttack(self.0.melee())
    }
    ...
    pub fn archery(self) -> BaseArtifactWeaponBuilderWithAttack {
        BaseArtifactWeaponBuilderWithAttack(self.0.archery())
    }
    ...
    pub fn thrown(self) -> BaseArtifactWeaponBuilderWithAttack {
        BaseArtifactWeaponBuilderWithAttack(self.0.thrown())
    }
