...
use crate::{
    ...
    CharacterMutationError, sorcery::circles::terrestrial::sorcerer_memo::TerrestrialCircleSorcererMemo,
};
...
impl MortalMemo {
    ...
    pub fn sorcery(&self) -> Option<&TerrestrialCircleSorcererMemo> {
        self.sorcery.as_ref()
    }
