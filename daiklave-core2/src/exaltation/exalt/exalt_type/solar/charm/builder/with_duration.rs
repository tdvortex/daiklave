...
use crate::{book_reference::BookReference, exaltation::exalt::exalt_type::solar::charm::{SolarCharmId, SolarCharmKeyword, ability::SolarCharmAbility}, charms::{CharmCostType, CharmActionType}};

use super::with_description::SolarCharmBuilderWithDescription;

/// A Solar Charm builder after the duration has been specified.
pub struct SolarCharmBuilderWithDuration {
...
impl SolarCharmBuilderWithDuration {
    ...
    /// Sets the description for the Charm.
    pub fn description(self, description: String) -> SolarCharmBuilderWithDescription {
        SolarCharmBuilderWithDescription {
            name: self.name,
