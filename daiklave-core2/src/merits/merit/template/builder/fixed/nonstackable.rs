use crate::{
    ...
    merits::merit::{template::nonstackable::FixedNonStackableMeritTemplate, MeritPrerequisite},
};
...
pub struct FixedNonStackableMeritTemplateBuilder(
    pub(crate) FixedMeritTemplateBuilderWithDescription,
);
