use crate::{book_reference::{BookReference, Book}, hearthstones::hearthstone::GeomancyLevel, languages::language::MajorLanguage};

use super::{instance::{SorceryArchetypeMerit, ARTIFACT_SHARED, DEMENSE_SHARED, EXALTED_HEALING, ARTIFACT_TWO, ARTIFACT_THREE, ARTIFACT_FOUR, ARTIFACT_FIVE, ARTIFACT_NA, DEMENSE_STANDARD, DEMENSE_GREATER, EXALTED_HEALING_EXALT, LANGUAGE_LOCAL_TONGUES, LANGUAGE_DRAGONTONGUE, LANGUAGE_FLAMETONGUE, LANGUAGE_FORESTTONGUE, LANGUAGE_GUILD_CANT, LANGUAGE_HIGH_REALM, LANGUAGE_LOW_REALM, LANGUAGE_OLD_REALM, LANGUAGE_RIVERSPEAK, LANGUAGE_SEATONGUE, LANGUAGE_SKYTONGUE, LANGUAGE_SHARED, MARTIAL_ARTIST, MORTAL_SORCERY}, manse::{MANSE_SHARED, MANSE_STANDARD, MANSE_GREATER}};

pub(crate) enum MeritSource<'source> {
    Artifact { name: &'source str, dots: u8},
    Demense { name: &'source str, has_manse: bool, geomancy_level: GeomancyLevel},
    ExaltedHealing { is_exalt: bool},
    LocalTongues { count: usize },
    MajorLanguage(MajorLanguage),
    Manse { name: &'source str, geomancy_level: GeomancyLevel},
    MartialArtist { style_name: &'source str },
    MortalSorcerer,
...
impl<'source> MeritSource<'source> {
    pub fn name(&self) -> &'source str {
        match self {
            ...
            MeritSource::Demense { name, has_manse, geomancy_level } => "Demense",
            ...
            MeritSource::Manse { name, geomancy_level } => "Manse",
            ...
            MeritSource::SorceryArchetype(sorcery_archetype_merit) => sorcery_archetype_merit.name(),
    ...
    pub fn detail(&self) -> Option<&'source str> {
        match self {
            ...
            MeritSource::Demense { name, has_manse, geomancy_level } => Some(*name),
            MeritSource::ExaltedHealing { is_exalt } => None,
            MeritSource::LocalTongues {count} => None,
            MeritSource::MajorLanguage(major_language) => {
                Some(match major_language {
            ...
            MeritSource::Manse { name, geomancy_level } => Some(*name),
            ...
            MeritSource::SorceryArchetype(sorcery_archetype_merit) => sorcery_archetype_merit.detail(),
    ...
    pub fn book_reference(&self) -> Option<BookReference> {
        match self {
            MeritSource::Artifact { name, dots } => Some(BookReference {book: Book::CoreRulebook, page_number: 159}),
            MeritSource::Demense { name, has_manse, geomancy_level } => Some(BookReference {book: Book::CoreRulebook, page_number: 160}),
            MeritSource::ExaltedHealing { is_exalt } => Some(BookReference {book: Book::CoreRulebook, page_number: 165}),
            MeritSource::LocalTongues { count } => Some(BookReference {book: Book::CoreRulebook, page_number: 162}),
            MeritSource::MajorLanguage(_) => Some(BookReference {book: Book::CoreRulebook, page_number: 162}),
            MeritSource::Manse { name, geomancy_level } => Some(BookReference {book: Book::CoreRulebook, page_number: 163}),
            MeritSource::MartialArtist { style_name } => Some(BookReference {book: Book::CoreRulebook, page_number: 163}),
            MeritSource::MortalSorcerer => Some(BookReference {book: Book::CoreRulebook, page_number: 470}),
            MeritSource::NonStackable(nonstackable) => nonstackable.book_reference(),
            MeritSource::SorceryArchetype(sorcery_archetype_merit) => sorcery_archetype_merit.book_reference(),
    ...
    pub fn dots(&self) -> u8 {
        match self {
            ...
            MeritSource::Demense { name, has_manse, geomancy_level } => {
                if *has_manse {
                    0
                } else {
            ...
            MeritSource::Manse { name, geomancy_level } => match geomancy_level {
            ...
            MeritSource::SorceryArchetype(sorcery_archetype_merit) => sorcery_archetype_merit.dots(),
    ...
    pub fn description(&self) -> &'source str {
        match self {
            ...
            MeritSource::Demense { name, has_manse, geomancy_level } => DEMENSE_SHARED,
            ...
            MeritSource::Manse { name, geomancy_level } => MANSE_SHARED,
            ...
            MeritSource::SorceryArchetype(sorcery_archetype_merit) => sorcery_archetype_merit.description(),
    ...
    pub fn dot_description(&self) -> Option<&'source str> {
        match self {
            MeritSource::Artifact { name, dots } => {
                Some(match dots {
                    2 => ARTIFACT_TWO,
                    3 => ARTIFACT_THREE,
                    4 => ARTIFACT_FOUR,
            ...
            MeritSource::ExaltedHealing { is_exalt } => if *is_exalt {
            ...
            MeritSource::Manse { name, geomancy_level } => Some(match geomancy_level {
