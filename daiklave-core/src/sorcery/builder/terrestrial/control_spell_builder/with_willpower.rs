...
use crate::{
    ...
    sorcery::{
        spell::{builder::SpellBuilderWithWillpower, SpellKeyword},
        ShapingRitualDetails, SorceryArchetypeDetails, SorceryArchetypeName,
    },
};

use super::TerrestrialControlSpellBuilderWithDuration;

/// A builder to construct a new spell to be the Control Spell for a
/// Terrestrial Circle initiation, after the willpower cost has been
/// specified.
pub struct TerrestrialControlSpellBuilderWithWillpower {
    ...
    pub(crate) spell_builder: SpellBuilderWithWillpower,
}

impl TerrestrialControlSpellBuilderWithWillpower {
    ...
    ) -> TerrestrialControlSpellBuilderWithDuration {
        TerrestrialControlSpellBuilderWithDuration {
            archetype_name: self.archetype_name,
            archetype: self.archetype,
            shaping_ritual_summary: self.shaping_ritual_summary,
            shaping_ritual: self.shaping_ritual,
            spell_builder: self.spell_builder.duration(duration.into()),
        }
    }
}
